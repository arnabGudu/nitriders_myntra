        ...
        <>
            <div className='navbar'>
                <div className='nav'>
                    ...
                    <div>
                        <Link className='navbar-brand' to='/'>NITRiders</Link>
                    </div>
            ...
            <div id='control-bar' className='control-bar'>
                ...
                <div className='control-bar-category-container'>
                    ...
                    <Link className='control-bar-link control-bar-category' to='/category/1/products'>Shirts</Link>
                    <Link className='control-bar-link control-bar-category' to='/category/2/products'>T-Shirts</Link>
                </div>
            </div>
        </>
    )
